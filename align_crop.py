...
from face_recognition.preprocess.align_dlib import AlignDlib

logger = logging.getLogger(__name__)

align_dlib = AlignDlib(os.path.expanduser('~/Data/openface/shape_predictor_68_face_landmarks.dat'))
